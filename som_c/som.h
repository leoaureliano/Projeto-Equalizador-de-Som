...
<<<<<<< HEAD
typedef struct Som__equalizador_mem {
=======
...
>>>>>>> 05b5256ae5305638d8072e36502413e69e00f23d
  ...
  int v_765;
  int pnr;
} Som__equalizador_mem;

typedef struct Som__equalizador_out {
  int s;
} Som__equalizador_out;

void Som__equalizador_reset(Som__equalizador_mem* self);

void Som__equalizador_step(int cvl, int clo, int cmi, int chi, int cvh,
                           int c, int up, int down,
                           Som__equalizador_out* _out,
                           Som__equalizador_mem* self);
